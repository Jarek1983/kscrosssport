...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post practices_url, params: { practice: { boxinfo: @practice.boxinfo, boxtitle: @practice.boxtitle, subtitle: @practice.subtitle, title: @practice.title } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { boxinfo: @practice.boxinfo, boxtitle: @practice.boxtitle, subtitle: @practice.subtitle, title: @practice.title } }
